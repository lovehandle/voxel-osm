...
OSM.prototype.generate = function ( x, y, z ) {
  ...
  position.scaleX(this.vFromLow, this.vFromHigh, 0, this.width)
  position.scaleY(this.vFromLow, this.vFromHigh, 0, this.width)
  position.scaleZ(this.vFromLow, this.vFromHigh, 0, this.width)
